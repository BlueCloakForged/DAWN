...
### ForgeScaffold CLI (Operator Workflow)

For ForgeScaffold-specific operations (apply/approve/status/query/explain/doctor), use:

- CLI Runbook: `docs/operator/CLI_RUNBOOK.md`
- CLI Reference: `docs/operator/CLI_REFERENCE.md`
